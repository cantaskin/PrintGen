...
namespace Persistence.Migrations
{
    ...
    [Migration("20240904130943_OrderUpdate2")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ec530ccb-0ba0-4c8b-9130-629b07c34645"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "myCrazyip@proton.me",
                            PasswordHash = new byte[] { 233, 174, 10, 142, 146, 64, 171, 149, 190, 59, 115, 124, 107, 11, 216, 102, 27, 158, 177, 87, 185, 206, 55, 213, 101, 101, 64, 168, 195, 109, 199, 94, 68, 79, 144, 235, 164, 88, 203, 152, 251, 32, 102, 120, 11, 126, 138, 173, 42, 64, 231, 172, 93, 113, 16, 221, 140, 53, 228, 89, 149, 25, 137, 148 },
                            PasswordSalt = new byte[] { 100, 255, 169, 46, 142, 70, 183, 121, 12, 37, 7, 72, 171, 109, 53, 77, 59, 134, 167, 179, 7, 204, 71, 55, 1, 192, 14, 238, 127, 145, 109, 199, 82, 226, 154, 125, 70, 81, 205, 145, 110, 14, 252, 33, 50, 87, 106, 20, 5, 196, 163, 232, 115, 98, 226, 9, 90, 177, 185, 209, 83, 198, 233, 118, 167, 210, 110, 247, 237, 42, 222, 160, 214, 117, 157, 160, 118, 192, 2, 19, 96, 230, 166, 152, 88, 35, 200, 36, 140, 104, 211, 67, 75, 191, 150, 137, 89, 15, 69, 130, 173, 220, 255, 104, 26, 219, 35, 220, 199, 252, 221, 17, 26, 245, 24, 228, 177, 29, 15, 117, 18, 77, 143, 230, 206, 99, 11, 184 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d36c01c7-ebda-4696-8662-10d08879bd8f"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("ec530ccb-0ba0-4c8b-9130-629b07c34645")
                        });
                });
