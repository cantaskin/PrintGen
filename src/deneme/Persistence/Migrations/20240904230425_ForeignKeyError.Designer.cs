...
namespace Persistence.Migrations
{
    ...
    [Migration("20240904230425_ForeignKeyError")]
    partial class ForeignKeyError
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d9359869-82c2-44e9-910c-bf1025df299e"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "myCrazyip@proton.me",
                            PasswordHash = new byte[] { 41, 89, 214, 133, 9, 101, 18, 112, 197, 81, 85, 2, 62, 242, 60, 8, 193, 170, 225, 20, 199, 16, 133, 107, 65, 188, 60, 200, 31, 41, 132, 252, 208, 93, 26, 150, 5, 101, 213, 80, 195, 48, 106, 161, 17, 57, 10, 146, 101, 170, 110, 17, 166, 116, 148, 162, 155, 75, 136, 242, 100, 57, 223, 172 },
                            PasswordSalt = new byte[] { 213, 17, 245, 191, 228, 254, 164, 86, 220, 173, 98, 107, 184, 27, 10, 97, 31, 194, 31, 175, 205, 2, 104, 142, 148, 185, 192, 179, 64, 41, 14, 185, 62, 233, 30, 177, 218, 36, 43, 4, 224, 16, 128, 87, 21, 93, 3, 216, 155, 63, 16, 180, 128, 130, 255, 150, 150, 217, 157, 155, 83, 154, 71, 225, 195, 30, 194, 159, 2, 35, 211, 16, 185, 193, 7, 215, 55, 151, 182, 70, 197, 83, 238, 137, 244, 209, 187, 133, 113, 238, 162, 93, 95, 30, 7, 175, 172, 182, 50, 161, 31, 121, 113, 192, 72, 35, 97, 90, 131, 76, 255, 145, 159, 0, 253, 214, 123, 235, 154, 18, 10, 10, 115, 235, 25, 186, 240, 182 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ab4547a0-6b08-428f-9735-04d8b3850456"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("d9359869-82c2-44e9-910c-bf1025df299e")
                        });
                });
