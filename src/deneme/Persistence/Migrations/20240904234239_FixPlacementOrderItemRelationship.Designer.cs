...
namespace Persistence.Migrations
{
    ...
    [Migration("20240904234239_FixPlacementOrderItemRelationship")]
    partial class FixPlacementOrderItemRelationship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e05ea876-ec43-4602-92a1-0f1651163f7c"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "myCrazyip@proton.me",
                            PasswordHash = new byte[] { 108, 118, 199, 180, 188, 50, 151, 103, 28, 70, 1, 46, 234, 152, 205, 177, 37, 173, 140, 54, 84, 130, 178, 46, 20, 170, 179, 119, 154, 193, 93, 10, 149, 234, 154, 254, 50, 208, 39, 91, 69, 156, 55, 228, 221, 239, 206, 81, 104, 130, 74, 26, 249, 102, 232, 68, 195, 116, 0, 43, 175, 116, 96, 242 },
                            PasswordSalt = new byte[] { 110, 45, 47, 233, 104, 232, 79, 214, 210, 103, 181, 232, 149, 162, 76, 164, 2, 211, 165, 251, 171, 75, 210, 230, 105, 60, 231, 13, 246, 80, 94, 242, 65, 85, 218, 172, 177, 12, 146, 173, 129, 92, 16, 247, 213, 83, 238, 181, 163, 21, 90, 202, 131, 180, 230, 50, 50, 219, 94, 39, 228, 24, 255, 113, 161, 165, 52, 140, 110, 139, 200, 253, 50, 242, 26, 217, 58, 30, 141, 179, 54, 15, 99, 84, 230, 67, 202, 169, 48, 84, 115, 116, 245, 57, 22, 161, 84, 61, 200, 104, 65, 252, 70, 220, 57, 197, 121, 122, 199, 136, 197, 82, 236, 112, 197, 100, 94, 133, 69, 25, 33, 49, 208, 34, 5, 128, 32, 80 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7bf09b0f-eef1-4aa3-b449-904b18b04985"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("e05ea876-ec43-4602-92a1-0f1651163f7c")
                        });
                });
