...
namespace Persistence.Migrations
{
    ...
    [Migration("20240904231343_UpdateOrderAndOrderItemRelationship")]
    partial class UpdateOrderAndOrderItemRelationship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fe7de3c3-b1a2-4c04-992a-cf0f47411c55"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "myCrazyip@proton.me",
                            PasswordHash = new byte[] { 46, 20, 181, 157, 176, 241, 43, 175, 224, 12, 237, 210, 218, 145, 107, 203, 254, 230, 225, 216, 84, 16, 124, 83, 112, 199, 193, 161, 41, 9, 217, 106, 46, 5, 1, 148, 221, 242, 71, 135, 217, 150, 178, 9, 113, 125, 35, 13, 63, 92, 63, 178, 151, 255, 0, 44, 114, 93, 12, 58, 99, 87, 7, 180 },
                            PasswordSalt = new byte[] { 123, 86, 171, 66, 52, 226, 248, 58, 166, 33, 82, 77, 28, 80, 147, 112, 136, 106, 1, 88, 68, 166, 194, 209, 88, 121, 55, 136, 213, 130, 46, 47, 185, 137, 35, 64, 41, 67, 40, 74, 78, 188, 205, 53, 77, 47, 102, 218, 224, 54, 14, 149, 100, 166, 128, 242, 111, 181, 111, 198, 6, 21, 157, 244, 180, 35, 96, 33, 143, 70, 121, 249, 54, 49, 100, 78, 140, 20, 229, 251, 115, 217, 103, 170, 239, 253, 157, 52, 157, 246, 213, 63, 236, 145, 146, 71, 46, 64, 174, 26, 67, 124, 2, 19, 37, 206, 185, 23, 242, 68, 98, 152, 249, 166, 255, 107, 23, 32, 221, 93, 30, 207, 249, 75, 24, 44, 119, 178 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b1e372d8-92b3-4978-ae44-7b3e6b7a26d0"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("fe7de3c3-b1a2-4c04-992a-cf0f47411c55")
                        });
                });
