...
namespace Persistence.Migrations
{
    ...
    [Migration("20240903210245_ApiId")]
    partial class ApiId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("92a9e024-36ce-4183-ac40-73e4e1cd7e59"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "myCrazyip@proton.me",
                            PasswordHash = new byte[] { 2, 85, 36, 175, 245, 203, 241, 157, 197, 137, 60, 103, 233, 234, 167, 220, 47, 89, 252, 128, 36, 145, 181, 171, 4, 55, 94, 97, 59, 140, 158, 117, 23, 40, 59, 22, 212, 97, 215, 218, 34, 159, 105, 73, 36, 95, 199, 164, 202, 36, 92, 29, 47, 173, 98, 198, 40, 47, 247, 6, 230, 4, 99, 242 },
                            PasswordSalt = new byte[] { 20, 163, 166, 157, 219, 254, 250, 91, 48, 147, 233, 253, 132, 30, 146, 170, 28, 195, 171, 158, 10, 250, 190, 24, 47, 126, 242, 134, 66, 244, 66, 245, 63, 43, 198, 249, 40, 189, 113, 90, 119, 232, 228, 85, 47, 220, 233, 73, 129, 141, 81, 98, 3, 240, 219, 101, 11, 224, 81, 81, 85, 183, 126, 214, 61, 222, 200, 240, 228, 79, 178, 30, 156, 196, 104, 102, 1, 75, 2, 182, 50, 249, 203, 199, 163, 175, 141, 198, 121, 59, 39, 47, 61, 189, 76, 8, 43, 234, 254, 112, 160, 164, 222, 12, 84, 219, 164, 1, 203, 253, 89, 156, 118, 160, 87, 5, 37, 174, 178, 123, 168, 209, 29, 129, 122, 111, 41, 245 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("71faeb02-5cf0-4c24-823b-254b0215644a"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("92a9e024-36ce-4183-ac40-73e4e1cd7e59")
                        });
                });
